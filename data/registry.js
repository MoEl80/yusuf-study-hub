/* Subject registry — mirrors Yusuf's Google Classroom classes (screenshot 2026-08-28).
...
(function (root) {
  root.YSH_SUBJECTS = [
    ...
    { id: 'history', name: 'History', icon: '🏛️', colour: '#b91c1c', className: 'Year 9 History 2026', teacher: 'Amity College' }
  ];
